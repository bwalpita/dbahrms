      ...
      <div className={`transition-all duration-300 pt-16 ${sidebarOpen ? 'ml-64' : 'ml-0'}`}>
        <main className="p-6">
          ...
          <div className="bg-gradient-to-r from-orange-400 to-orange-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
            ...
            <div className="absolute right-0 top-0 w-2/3 h-full opacity-30 transition-opacity duration-700">
              <img
                src={currentImage}
                alt="Background"
              ...
              {modules.map((module) => {
                ...
                return (
                  <div
                    key={module.path}
                    className="relative"
                    onMouseEnter={() => setHoveredModule(module.path)}
                    onMouseLeave={() => setHoveredModule(null)}
                  >
                    <button
                      onClick={() => navigate(module.path)}
                      className="w-full group relative overflow-hidden bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                    >
                      <div
                      ...
                      <div className="relative z-10">
                        <div
                          className={`w-20 h-20 bg-gradient-to-br ${module.color} rounded-2xl flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300`}
                        >
                    ...
                    <PetalMenu
                      isVisible={isHovered}
                      onAction={(action) => handlePetalAction(module.path, action)}
                    />
                  </div>
                );
              })}
